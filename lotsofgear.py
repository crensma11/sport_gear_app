...
gearItem1 = GearItem(
    user_id=1, name="Helmet", description="A piece of protective"
...
gearItem2 = GearItem(
    user_id=1, name="Neck Roll", description="a thick piece of padded"
...
gearItem3 = GearItem(
    user_id=1, name="Football Cleats", description="Cleats or studs are"
...
gearItem4 = GearItem(
    user_id=1, name="Mouth Guard", description="A mouth guard is a soft"
...
gearItem5 = GearItem(
    user_id=1, name="Thigh, Hip and Knee Pads", description="Hip and"
...
gearItem6 = GearItem(
    user_id=1, name="Shoulder Pads", description="Shoulder pads consist"
...
gearItem1 = GearItem(
    user_id=1, name="Basketball Sneakers", description="Players should"
...
gearItem2 = GearItem(
    user_id=1, name="Athletic Socks", description="Players should wear"
...
gearItem3 = GearItem(
    user_id=1, name="Athletic Shorts", description="Players should wear"
...
gearItem4 = GearItem(
    user_id=1, name="Athletic Jersey", description="Players should wear"
...
gearItem5 = GearItem(
    user_id=1, name="Mouth Piece", description="Players should wear a"
...
gearItem6 = GearItem(
    user_id=1, name="Basketball", description="This falls more in the"
...
gearItem1 = GearItem(
    user_id=1, name="Baseball Ceats", description="Cleats began to be"
...
gearItem2 = GearItem(
    user_id=1, name="Glove", description="A baseball glove or mitt is a"
...
gearItem3 = GearItem(
    user_id=1, name="Bat", description="A baseball bat is a smooth"
...
gearItem4 = GearItem(
    user_id=1, name="Baseball", description="the ball used in this game,"
...
gearItem5 = GearItem(
    user_id=1, name="Uniform", description="A baseball uniform is a type"
...
gearItem1 = GearItem(
    user_id=1, name="Clubs", description="A golf club is a club used to"
...
gearItem2 = GearItem(
    user_id=1, name="Shoes", description="an oxford shoe of waterproof"
...
gearItem3 = GearItem(
    user_id=1, name="Balls", description="a small, white ball with a"
...
gearItem4 = GearItem(
    user_id=1, name="Tees", description="A golf tee is typically a thin,"
...
gearItem5 = GearItem(
    user_id=1, name="Divot Tool", description="A small, pronged, plastic"
...
gearItem6 = GearItem(
    user_id=1, name="Range Finder", description="Golf GPS rangefinders"
